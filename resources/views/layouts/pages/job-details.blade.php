...
@section('content')
    <div id="main-wrapper" class="page-wrapper">
        <div style="margin-top:80px" class="section-padding style-light">
            <div class="container">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="text-wrapper">
                            <p class="lead-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                            </p>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                                been the industry's standard dummy text ever since the 1500s, when an unknown printer took a
                                galley of type and scrambled it to make a type specimen book.</p>
                            <p>When an unknown printer took a galleywhen an unknown printer tookLorem Ipsum is simply dummy
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <form>
                            ...
                            <div class="form-group">
                                <input id="upload" type="file" class="form-control" id="inputAddress"
                                    placeholder="Choose File">
                                <div class="upload-main">
                                    <div class="upload-path"><span id="upload-res"></span><span
                                            class="upload-close">Remove.</span></div>
                                    <div class="uploadInput"><label for="upload" class="Uin">Upload Your
                                            Resume</label><span>( Supports PDF, DOC )</span></div>
                                </div>
                            </div>
                            <div class="form-group">
